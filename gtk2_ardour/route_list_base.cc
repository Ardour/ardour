	...
	, _route_deletion_in_progress (false)
{
	...
	setup_col (append_toggle (_columns.trigger, _columns.is_track, sigc::mem_fun (*this, &RouteListBase::on_tv_trigger_changed)),  S_("Trigger|T"), _("Visible on TriggerPage ?"));
