...
UI_CONFIG_VARIABLE (ARDOUR::samplecnt_t, clock_display_limit, "clock-display-limit", 94576) /* seconds; default about 24hrs @ 96kHz limited by size of int62_t, 0 = unlimited */
