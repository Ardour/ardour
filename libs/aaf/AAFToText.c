...
const char *aaft_MobIDToText(aafMobID_t *mobid) {
  ...
  for (i = 0; i < sizeof(aafMobID_t); i++) {
    ...
    rc = snprintf(str + offset, strsz - offset, "%02x",
                  ((unsigned char *)mobid)[i]);
...
const char *aaft_VersionToText(aafVersionType_t *vers) {
  ...
  if (vers == NULL) {
    ...
    int rc = snprintf(str, sizeof(str), "%i.%i", vers->major, vers->minor);
...
const char *aaft_ProductVersionToText(aafProductVersion_t *vers) {
  ...
  if (vers == NULL) {
    ...
    int rc = snprintf(str, sizeof(str), "%u.%u.%u.%u %s (%i)", vers->major,
...
const char *aaft_ByteOrderToText(int16_t bo) {
  switch (bo) {
...
const char *aaft_ElectroSpatialToText(aafElectroSpatialFormulation_t e) {
  ...
  case AAFElectroSpatialFormulation_SingleChannelDoubleSamplingFrequencyMode:
    return "AAFElectroSpatialFormulation_"
           "SingleChannelDoubleSamplingFrequencyMode";
  case AAFElectroSpatialFormulation_StereoLeftChannelDoubleSamplingFrequencyMode:
    return "AAFElectroSpatialFormulation_"
           "StereoLeftChannelDoubleSamplingFrequencyMode";
  case AAFElectroSpatialFormulation_StereoRightChannelDoubleSamplingFrequencyMode:
    return "AAFElectroSpatialFormulation_"
           "StereoRightChannelDoubleSamplingFrequencyMode";
...
const char *aaft_ParameterToText(AAF_Data *aafd, const aafUID_t *auid) {
  ...
  while (_aaf_foreach_ObjectInSet(&ParameterDefinition, ParameterDefinitions,
                                  NULL)) {
...
const char *aaft_IndirectValueToText(AAF_Data *aafd, aafIndirect_t *Indirect) {
  ...
  if (aafUIDCmp(&Indirect->TypeDef, &AAFTypeID_Boolean)) {
    ...
    rc = snprintf(buf, sizeof(buf), "%i/%i",
                  ((aafRational_t *)indirectValue)->numerator,
                  ((aafRational_t *)indirectValue)->denominator);
  }
    ...
    error("Unsupported Indirect value type ID : %s",
...
const char *aaft_ContainerToText(const aafUID_t *auid) {
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_50Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_50Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_40Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_40Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_30Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_30Mbps_"
           "DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_Framewrapped_IECDV_525x5994I_25Mbps_"
           "SMPTE322M";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return "AAFContainerDef_MXFGC_CustomClosedGOPwrapped_MPEGES_VideoStream1_"
           "SID";
  if (aafUIDCmp(
          auid,
