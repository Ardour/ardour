...
/*
 *  NOTE looks like it is the way ProTools represents Stereo (5.1, 7.1 ???)
 * Tracks whenever "Export Stereo, 5.1 and 7.1 tracks as multi-channel" is
 * enabled.
 */
...
static const aafUID_t AAFOperationDef_AudioChannelCombiner = {
    ...
    0x132d,
    0x4856,
    {0xab, 0x21, 0x8b, 0x75, 0x1d, 0x84, 0x62, 0xec}};
