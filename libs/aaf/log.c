...
void laaf_write_log(struct aafLog *log, void *ctxdata, enum log_source_id lib,
                    enum verbosityLevel_e type, const char *srcfile,
  ...
  log->log_callback(log, (void *)ctxdata, lib, type, srcfile, srcfunc, srcline,
                    log->_msg, log->user);
