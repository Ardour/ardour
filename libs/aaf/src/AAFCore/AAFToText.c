...
const wchar_t *aaft_TimestampToText(aafTimeStamp_t *ts) {
  ...
  if (ts == NULL) {
    ...
    swprintf(str, sizeof(str), L"%04i-%02u-%02u %02u:%02u:%02u.%02u",
             ...
             ts->time.minute, ts->time.second, ts->time.fraction);
  }
...
const wchar_t *aaft_VersionToText(aafVersionType_t *vers) {
  ...
  if (vers == NULL) {
    ...
    swprintf(str, sizeof(str), L"%i.%i", vers->major, vers->minor);
  }
...
const wchar_t *aaft_ProductVersionToText(aafProductVersion_t *vers) {
  ...
  if (vers == NULL) {
    ...
    swprintf(str, sizeof(str), L"%u.%u.%u.%u %" WPRIws L" (%i)", vers->major,
             vers->minor, vers->tertiary, vers->patchLevel,
             aaft_ProductReleaseTypeToText(vers->type), vers->type);
  }
...
const wchar_t *aaft_ElectroSpatialToText(aafElectroSpatialFormulation_t e) {
  ...
  case AAFElectroSpatialFormulation_SingleChannelDoubleSamplingFrequencyMode:
    return L"AAFElectroSpatialFormulation_"
           L"SingleChannelDoubleSamplingFrequencyMode";
  case AAFElectroSpatialFormulation_StereoLeftChannelDoubleSamplingFrequencyMode:
    return L"AAFElectroSpatialFormulation_"
           L"StereoLeftChannelDoubleSamplingFrequencyMode";
  case AAFElectroSpatialFormulation_StereoRightChannelDoubleSamplingFrequencyMode:
    return L"AAFElectroSpatialFormulation_"
           L"StereoRightChannelDoubleSamplingFrequencyMode";
...
const wchar_t *aaft_DataDefToText(AAF_Data *aafd, const aafUID_t *auid) {
  ...
  aaf_foreach_ObjectInSet(&DataDefinition, DataDefinitions, NULL) {
    ...
    aafUID_t *DataDefIdent = aaf_get_propertyValue(
    ...
    if (DataDefIdent && aafUIDCmp(DataDefIdent, auid)) {
      wchar_t *name = aaf_get_propertyValue(
          DataDefinition, PID_DefinitionObject_Name, &AAFTypeID_String);
...
const wchar_t *aaft_ParameterToText(AAF_Data *aafd, const aafUID_t *auid) {
  ...
  aaf_foreach_ObjectInSet(&ParameterDefinition, ParameterDefinitions, NULL) {
    ...
    aafUID_t *ParamDefIdent = aaf_get_propertyValue(
        ParameterDefinition, PID_DefinitionObject_Identification,
        &AAFTypeID_AUID);
    ...
    foreachPropertyDefinition(PDef, Class->Properties) {
      ...
      if (PDef->pid == pid) {
        swprintf(PIDText, 1024, L"%" WPRIs L"%" WPRIws L"%" WPRIs,
                 (PDef->meta) ? ANSI_COLOR_YELLOW(aafd->dbg) : "", PDef->name,
  ...
  foreachClass(Class, aafd->Classes) {
    ...
    if (aafUIDCmp(Class->ID, auid)) {
      swprintf(ClassIDText, 1024, L"%" WPRIs L"%" WPRIws L"%" WPRIs,
               (Class->meta) ? ANSI_COLOR_YELLOW(aafd->dbg) : "", Class->name,
...
const wchar_t *aaft_ContainerToText(const aafUID_t *auid) {
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_50Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_50Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_40Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_40Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_625x50I_30Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_SMPTE_D10_525x5994I_30Mbps_"
           L"DefinedTemplate";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(auid,
                &AAFContainerDef_MXFGC_Clipwrapped_IECDV_525x5994I_25Mbps))
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_Framewrapped_IECDV_525x5994I_25Mbps_"
           L"SMPTE322M";
  if (aafUIDCmp(
          auid,
          &AAFContainerDef_MXFGC_Clipwrapped_IECDV_525x5994I_25Mbps_SMPTE322M))
    return L"AAFContainerDef_MXFGC_Clipwrapped_IECDV_525x5994I_25Mbps_"
           L"SMPTE322M";
  if (aafUIDCmp(
          auid,
  ...
  if (aafUIDCmp(auid,
                &AAFContainerDef_MXFGC_Clipwrapped_DVbased_625x50I_25Mbps))
  ...
  if (aafUIDCmp(auid,
                &AAFContainerDef_MXFGC_Clipwrapped_DVbased_625x50I_50Mbps))
  ...
  if (aafUIDCmp(
    ...
    return L"AAFContainerDef_MXFGC_CustomClosedGOPwrapped_MPEGES_VideoStream1_"
           L"SID";
  if (aafUIDCmp(
          auid,
