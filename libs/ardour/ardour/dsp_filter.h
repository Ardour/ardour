...
namespace ARDOUR { namespace DSP {
	...
	public:
		...
		virtual float power_at_bin (const uint32_t bin, const float gain, bool flat) const = 0;
	...
	class LIBARDOUR_API FFTSpectrum : public SpectrumAnalyzer {
		public:
			 ...
			 */
			float power_at_bin (const uint32_t bin, const float gain = 1.f, bool flat = true) const;
