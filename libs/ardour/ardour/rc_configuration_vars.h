...
CONFIG_VARIABLE (float, audio_capture_buffer_seconds, "capture-buffer-seconds", 10.0)
CONFIG_VARIABLE (float, audio_playback_buffer_seconds, "playback-buffer-seconds", 10.0)
...
CONFIG_VARIABLE (std::string, global_replication_path, "global-replication-path", "")
...
CONFIG_VARIABLE (bool, super_rapid_clock_update, "super-rapid-clock-update", true)
