...
CONFIG_VARIABLE (bool, show_vst3_micro_edit_inline, "show-vst3-micro-edit-inline", false)
...
CONFIG_VARIABLE (std::string, default_export_format, "default-export-format", "dd4f6f30-f054-4e0a-8d91-67eed5d79153") // "Wav (Tagged)"
