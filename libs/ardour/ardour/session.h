...
public:
	...
	*/
	...
	void reorder_route_groups (std::list<std::shared_ptr<RouteGroup>>);
	...
	std::list<std::shared_ptr<RouteGroup>> const & route_groups () const {
...
private:
	...
	*/
	...
	std::list<std::shared_ptr<ARDOUR::RouteGroup>> _route_groups;
