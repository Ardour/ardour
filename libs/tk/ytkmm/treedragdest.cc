...
#include <ytkmm/private/treedragdest_p.h>
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->drag_data_received)(self, dest, selection_data);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->row_drop_possible)(self, dest_path, selection_data);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->drag_data_received)
  {
    bool retval((*base->drag_data_received)(gobj(),const_cast<GtkTreePath*>((dest).gobj()),const_cast<GtkSelectionData*>((selection_data).gobj())));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->row_drop_possible)
  {
    bool retval((*base->row_drop_possible)(const_cast<GtkTreeDragDest*>(gobj()),const_cast<GtkTreePath*>((dest).gobj()),const_cast<GtkSelectionData*>((selection_data).gobj())));
    return retval;
  }
