...
<MackieDeviceProfile>
  <Name value="BCF2000 Basic Editing/Mixing"/>
  ...
  <Buttons>
    ...
    <Button name="Write" plain="Editor/selected-marker-to-previous-region-boundary"/>
    ...
    <Button name="F4" plain="Editor/save-visual-state-4"/>
    <Button name="F5" plain="Editor/save-visual-state-5"/>
    <Button name="F6" plain="Editor/save-visual-state-6"/>
    <Button name="F7" plain="Editor/save-visual-state-7"/>
    <Button name="F8" plain="Editor/save-visual-state-8"/>
  </Buttons>
</MackieDeviceProfile>
